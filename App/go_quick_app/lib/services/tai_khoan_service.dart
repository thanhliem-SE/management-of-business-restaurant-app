...
class TaiKhoanService {
  ...
  Future<Object> updateTaiKhoan(String token, TaiKhoan taiKhoan) async {
    try {
      final response = await http.put(
        Uri.parse(api + 'taikhoan/' + taiKhoan.tenTaiKhoan.toString()),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<Object> resetMatKhau(String token, String tenTaiKhoan) async {
    try {
      final response = await http.get(
        Uri.parse(api + 'taikhoan/reset/' + tenTaiKhoan),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          HttpHeaders.authorizationHeader: '$token'
        },
